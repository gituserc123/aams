...
row[_826[i]]=$(this).find("td:eq("+i+")")[0].innerHTML;
}
data.rows.push(row);
});
return data;
...
$(_829).empty();
$(_829)[0].innerHTML = this.renderTable(_828,0,rows,_82a);
...
$.fn.combogrid.defaults=$.extend({},$.fn.combo.defaults,$.fn.datagrid.defaults,{loadMsg:null,idField:null,textField:null,unselectedValues:[],mappingRows:[],mode:"local",scrollOnSelect: false,keyHandler:{up:function(e){
nav(this,"prev");
e.preventDefault();
},down:function(e){
nav(this,"next");
